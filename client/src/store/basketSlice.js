...
export const getItemCountLS = () => {
  ...
  console.log('getItemCountLS function called')
...
// Функція для збереження кількості товарів у локальному сховищі
...
export const basketSlice = createSlice({
  ...
  reducers: {
    addToBasket: (state, action) => {
      ...
      saveItemCountLS(state.basketItemCount) // Зберігаємо оновлену кількість товарів у корзині в локальному сховищі
    },
    ...
    clearBasket: (state) => {
      ...
      saveItemCountLS(state.basketItemCount) // Видаляємо кількість товарів у корзині з локального сховища при очищенні корзини
    },
...
export const { addToBasket, removeFromBasket, clearBasket, updateBasketItemCount } = basketSlice.actions
